  ...
  <Grid textAlign="center" columns="equal">
    ...
    <Grid.Row>
      ...
      <Grid.Column>
        <Statistic
          size="mini"
          color={parseInt(props.Subreddit.one_day_change) < 0 ? "red" : "green"}
        >
          <Statistic.Value>{props.Subreddit.one_day_change}%</Statistic.Value>
      ...
      <Grid.Column>
        <Statistic
          size="mini"
          color={
            parseInt(props.Subreddit.seven_day_change) < 0 ? "red" : "green"
          }
        >
          <Statistic.Value>{props.Subreddit.seven_day_change}%</Statistic.Value>
      ...
      <Grid.Column>
        <Statistic
          size="mini"
          color={
            parseInt(props.Subreddit.thirty_day_change) < 0 ? "red" : "green"
          }
        >
          <Statistic.Value>
